      ...
      <div className="hit sm:flex">
        ...
        <div className="hit-content mt-1 px-2 sm:w-3/5 sm:mt-0">
          ...
          <div className="flex items-center">
            <GarageRating props={{rating:hit.garage_rating, zIndex:-1}}/>
          </div>
          <div className="flex">
          ...
          <div className="w-28"><span className="my-1 px-4 py-2 flex items-center text-base rounded-full text-gray-600  bg-gray-200 ">
