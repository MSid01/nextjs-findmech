...
const HitComponent = ({ hit }) => {
  ...
  // const openingTimeinInt = parseInt(openingTime[0]);
  // const closingTimeinInt = parseInt(closingTime[0]);
  ...
  return (
    <div className="hit sm:flex">
      <div className="w-full relative z-[-1] h-48 sm:w-2/5">
        <Image
          className="rounded"
      ...
      <div className="hit-content sm:w-3/5 px-2">
        <div>
          <Highlight
        ...
        <div className="flex items-center flex-wrap">
          ...
          <span className="ml-2 px-3 py-1  text-base rounded-full text-white  bg-red-500 ">
  ...
  render() {
    return (
      ...
      >
        ...
        <header>
          <SearchBox
            className="py-3 w-full m-auto px-5"
            translations={{ placeholder: "Search by name, city, village, district, landmark, pin-code..." }}
          />
